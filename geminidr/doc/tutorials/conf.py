# Tutorials build configuration file
...
texinfo_documents = [
  ('index', 'Tutorials', 'Tutorials',
   'Kathleen Labrie', 'Tutorials',
   'Tutorials for DRAGONS reduction',
   'Miscellaneous'),
]
