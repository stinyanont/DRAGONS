# Recipe System build configuration file
...
htmlhelp_basename = 'RecipeSystemManual'
...
latex_documents = [
  ('index', 'RecipeSystemManual.tex', 'Recipe System Manual',
...
man_pages = [
    ('index', 'recipesystemmanual', 'Recipe System Manual',
     ['Kathleen Labrie'], 1)
]
...
texinfo_documents = [
  ('index', 'RecipeSystemManual', 'Recipe System Manual',
   'Kathleen Labrie', 'RecipeSystemManual',
   'Manual for the recipe_system package',
   'Miscellaneous'),
]
